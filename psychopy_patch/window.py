...
class Window():
    ...
    def __init__(self,
                 ...
                 fullscr=None,
                 allowGUI=None,
                 win_style=None, # added by LiHaobo 2024.6.28 (li.haobo@connect.um.edu.mo)
                                 # refers to pyglet window style (https://docs.pyglet.org/en/latest/programming_guide/windowing.html)
                 monitor=None,
                 bitsMode=None,
                 winType=None,
                 units=None,
        ...
        * Some parameters (e.g. units) can now be given default values in the
        ...
        self.win_style = win_style    # added by LiHaobo 2024.6.28 (li.haobo@connect.um.edu.mo)
    ...
    def color(self, value):
        ...
        if self.backend is not None:
            ...
            print("win_style:", self.win_style)
            if self.win_style in {'overlay', 'transparent'}: #added by Lihaobo 2024.6.28
    ...
    def getMsPerFrame(self, nFrames=60, showVisual=False, msg='', msDelay=0.):
        ...
        for i in range(nFrames):  # ... and go for real this time
            ...
            if showVisual:
                ...
                myStim.setOpacity(.9 / nFrames, '+', log=False) #.9record
                myStim.draw()
            elif showText:
                myMsg.draw()
            if doWait:
