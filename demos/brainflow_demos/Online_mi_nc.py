...
def read_data(run_files, chs, interval, labels):
    ...
    for run_file in run_files:
        ...
        raw.filter(4, 40, l_trans_bandwidth=2, h_trans_bandwidth=5,
                   phase='zero-double')
...
class FeedbackWorker(ProcessWorker):
    ...
    def consume(self, payload):
        ...
        print('the real label is:',self.current_label,'and the predicted label is:',p_labels)
