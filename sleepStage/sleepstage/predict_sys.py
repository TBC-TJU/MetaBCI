...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_file", type=str, required=False,
                        default=path+"/sleepstage/config/sleepedf.py")
    parser.add_argument("--model_dir", type=str, required=False,
                        default=path+"/sleepstage/out_sleepedf/train")
    parser.add_argument("--output_dir", type=str, required=False,
                        default=path+"/sleepstage/out_sleepedf/predict")
    parser.add_argument("--log_file", type=str, required=False,
                        default=path+"/sleepstage/out_sleepedf/predict.log")
