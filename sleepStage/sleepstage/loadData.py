...
def stageOfNpz(
    ...
    offset1 = datetime.timedelta(seconds=-120)
    time = time + offset1
    # 计算偏移量
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_file", type=str, required=False,
                        default=path+"\MCASleepNet\config\sleepedf.py")
    parser.add_argument("--model_dir", type=str, required=False,
                        default=path+"\MCASleepNet\out_sleepedf\train")
    parser.add_argument("--output_dir", type=str, required=False,
                        default=path+"\MCASleepNet\out_sleepedf\predict")
    parser.add_argument("--log_file", type=str, required=False,
                        default=path+"\MCASleepNet\out_sleepedf\predict.log")
