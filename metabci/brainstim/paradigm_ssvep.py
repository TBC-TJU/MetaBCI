...
class KeyboardInterface(object):
    ...
    def config_pos(
        ...
        if (stim_pos is not None) and (self.n_elements == stim_pos.shape[0]):
            ...
            first_pos = np.array([-805, 0])
            for i in range(columns):
                for j in range(rows):
                    stim_pos[i * rows + j] = first_pos + [i * 230, 0]
            self.stim_pos = stim_pos
        else:
    ...
    def config_text(
        ...
        if (symbols is not None) and (len(symbols) >= self.n_elements):
            ...
            self.symbols = "".join(["1234567890+-*/"])    # string.ascii_uppercase
        else:
...
class VisualStim(KeyboardInterface):
    ...
    def config_index(self):
        self.index = os.path.join(
            ...
            "textures" + os.sep + "index1.png",
        )

        self.index_stimuli = visual.ImageStim(
            win=self.win,
            image=self.index,
            units='pix',
            size=[[200, 200]]
    ...
    #     if index_height == 0:
    #         index_height = copy(self.stim_width / 3)
...
class SSVEP(VisualStim):
    ...
    def black_block(self):
        self.black_stimuli1 = visual.Rect(
            win=self.win,
            units='',
            fillColor='black',
            # colorSpace='rgb',
        ...
        self.black_stimuli2 = visual.Rect(
            win=self.win,
            units='',
            fillColor='black',
            # colorSpace='rgb',
        ...
        self.black_stimuli3 = visual.Rect(
            win=self.win,
            units='',
            fillColor='black',
            # colorSpace='rgb',
        ...
        self.black_stimuli4 = visual.Rect(
            win=self.win,
            units='',
            fillColor='black',
            # colorSpace='rgb',
        ...
        self.black_stimuli5 = visual.Rect(
            win=self.win,
            units='',
            fillColor='black',
            # colorSpace='rgb',
        ...
        self.black_stimuli6 = visual.Rect(
            win=self.win,
            units='',
            fillColor='black',
            # colorSpace='rgb',
        ...
        self.black_stimuli7 = visual.Rect(
            win=self.win,
            units='',
            fillColor='black',
            # colorSpace='rgb',
    ...
    def white_block(self):     # rest+cue
        self.white_stimuli1 = visual.Rect(
            win=self.win,
            units='',
            fillColor='white',
            # colorSpace='rgb',
        ...
        self.white_stimuli2 = visual.Rect(
            win=self.win,
            units='',
            fillColor='white',
            # colorSpace='rgb',
        ...
        self.white_stimuli3 = visual.Rect(
            win=self.win,
            units='',
            fillColor='white',
            # colorSpace='rgb',
        ...
        self.white_stimuli4 = visual.Rect(
            win=self.win,
            units='',
            fillColor='white',
            # colorSpace='rgb',
        ...
        self.white_stimuli5 = visual.Rect(
            win=self.win,
            units='',
            fillColor='white',
            # colorSpace='rgb',
        ...
        self.white_stimuli6 = visual.Rect(
            win=self.win,
            units='',
            fillColor='white',
            # colorSpace='rgb',
        ...
        self.white_stimuli7 = visual.Rect(
            win=self.win,
            units='',
            fillColor='white',
            # colorSpace='rgb',
        ...
        self.white_stimuli8 = visual.Rect(
            win=self.win,
            units='',
            fillColor='white',
            # colorSpace='rgb',
    ...
    def grey_block(self):
        self.grey_block_lists = []
        self.grey_block_lists.append(
            visual.Rect(
                win=self.win,
                units='',
                fillColor='grey',
        ...
        for trial in trials:
            ...
            while iframe < int(fps * index_time):
                ...
                for text_stimulus in VSObject.text_stimuli:
                    text_stimulus.draw()
                VSObject.back_stimuli.draw()
                # draw whtie and black blocks
                VSObject.white_stimuli1.draw()
                VSObject.white_stimuli2.draw()
                VSObject.white_stimuli3.draw()
                VSObject.white_stimuli4.draw()
                VSObject.white_stimuli5.draw()
                VSObject.white_stimuli6.draw()
                VSObject.white_stimuli7.draw()
                VSObject.white_stimuli8.draw()
                VSObject.black_stimuli1.draw()
                VSObject.black_stimuli2.draw()
                VSObject.black_stimuli3.draw()
                VSObject.black_stimuli4.draw()
            ...
            if inlet:
                ...
                while iframe < int(fps * response_time):
                    ...
                    stim_sizes_res = VSObject.stim_sizes
                    stim_pos_res = VSObject.stim_pos
                    stim_sizes_res[predict_id, 0] -= 30
                    stim_sizes_res[predict_id, 1] -= 20
                    # VSObject.rect_response.draw()

                    # VSObject.text_response.text = VSObject.symbol_text
                    # VSObject.text_response.pos = res_text_pos
                    # VSObject.text_response.draw()
                    position = VSObject.stim_pos[predict_id] + np.array([0, VSObject.stim_width / 2 + 100])
                    VSObject.index_stimuli.setPos(position)
                    VSObject.index_stimuli.draw()
                    VSObject.grey_block_lists[predict_id].draw()
                    VSObject.black_stimuli1.draw()
                    VSObject.black_stimuli2.draw()
                    VSObject.black_stimuli3.draw()
                    VSObject.black_stimuli4.draw()
