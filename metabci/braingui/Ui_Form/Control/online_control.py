...
class Ui_online_Form(object):
    ...
    def retranslateUi(self, online_Form):
        ...
        self.comboBox_gettype.setItemText(0, _translate("online_Form", "博瑞康旧版采集设备"))
        self.comboBox_gettype.setItemText(1, _translate("online_Form", "博瑞康W4多模态采集设备"))
        ...
        self.comboBox_robot_model.setItemText(0, _translate("online_Form", "程天下肢外骨骼"))
        self.comboBox_robot_model.setItemText(1, _translate("online_Form", "傅里叶下肢外骨骼"))
        self.comboBox_robot_model.setItemText(2, _translate("online_Form", "傅里叶上肢康复平台"))
